...
module Plugins::Ecommerce::EcommerceHelper
  ...
  def ecommerce_form_post(d)
    if d[:post_type].slug == 'commerce'
      append_asset_libraries({ecommerce: {css: [], js: [plugin_asset_path("ecommerce", "js/fix_form")]}})
    end
    d
  end
  ...
  def ecommerce_admin_before_load
    ...
    # add assets admin
    append_asset_libraries({ecommerce: {css: [plugin_asset_path("ecommerce", "css/admin")], js: [plugin_asset_path("ecommerce", "js/admin")]}})
  ...
  def ecommerce_add_assets_in_front
    append_asset_libraries({ecommerce_front: {css: [plugin_asset_path("ecommerce", "css/front")], js: [plugin_asset_path("ecommerce", "js/cart")]}})
  end
